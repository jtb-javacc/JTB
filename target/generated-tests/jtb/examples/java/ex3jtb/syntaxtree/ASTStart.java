...
/**
 * JTB node class for the production ASTStart:<br>
 * Corresponding grammar:<br>
 * f0 -> Expression()<br>
 * f1 -> ";"<br>
 * s: 1859009853<br>
 */
public class ASTStart implements INode {

  /** Child node 0 */
  public ASTExpression f0;
   ...
   */
  public ASTStart(final ASTExpression n0, final NodeToken n1) {
    f0 = n0;
    if (f0 != null)
      f0.setParent(this);
    f1 = n1;
