...
// Please report to support with a real example of your grammar if you want the suffix to be generated : $1 [ ?0 "." ?1 < IDENTIFIER > ]
  ...
  public void visit(final expch_em_lxac n, final A argu) {
    // f0 -> ( %0 ":poi"
    // .. .. | %1 ":uyt"
    // .. .. | %2 ":rez"
    // .. .. | %3 {} )
  ...
  public void visit(final expch_eu_a n, final A argu) {
    // f0 -> . %0 < abID >
    // .. .. | %1 {}
    // .. .. | %2 < OP:["+"] >
    // .. .. | %3 #0 "*1"
