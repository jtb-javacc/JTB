...
/**
 * JTB node class for the production bp_DoubleThrows:<br>
 * Corresponding grammar:<br>
 * s: 0<br>
 */
public class bp_DoubleThrows implements INode {

  /** The serial version UID */
  private static final long serialVersionUID = 151L;

  /**
   * Constructs the node with no child node.
   *
   */
  public bp_DoubleThrows() {
  }
  /*
