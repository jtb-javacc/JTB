...
package grammars.q.visitor.signature;
...
import grammars.q.syntaxtree.NodeConstants;

@SuppressWarnings("javadoc")
@SupportedAnnotationTypes("grammars.q.visitor.signature.NodeFieldsSignature")
      ...
      for (final Element elem : roundEnv.getElementsAnnotatedWith(NodeFieldsSignature.class)) {
        ...
        if (osig != nsig) {
          final String message = "Different node fields signatures (old=" + nfs.value()[0] + ", new=" +
                                 nfs.value()[1] + ") in grammars.q.visitor." +
