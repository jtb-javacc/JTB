...
public class DepthFirstRetArguVisitor<R, A> implements IRetArguVisitor<R, A> {
   ...
   * @param a - the user argument
   * @return the user return information
   */
  public R visit(final NodeChoice n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    final R r = n.choice.accept(this, a);
    return r;
  }
   ...
   * @return the user return information
   */
  public R visit(final NodeList n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    R r = null;
    for (final Iterator<INode> e = n.elements(); e.hasNext();) {
      @SuppressWarnings("unused")
      final R sRes = e.next().accept(this, a);
    }
    return r;
  }
   ...
   * @return the user return information
   */
  public R visit(final NodeListOptional n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    if (n.present()) {
      R r = null;
      for (final Iterator<INode> e = n.elements(); e.hasNext();) {
        @SuppressWarnings("unused")
        R sRes = e.next().accept(this, a);
        }
      return r;
    } else
      return null;
   ...
   * @return the user return information
   */
  public R visit(final NodeOptional n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    if (n.present()) {
      final R r = n.node.accept(this, a);
      return r;
    } else
      return null;
  }
   ...
   * @return the user return information
   */
  public R visit(final NodeSequence n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    R r = null;
    for (final Iterator<INode> e = n.elements(); e.hasNext();) {
      @SuppressWarnings("unused")
      R subRet = e.next().accept(this, a);
    }
    return r;
  }
   ...
   * @return the user return information
   */
  public R visit(final NodeTCF n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    R r = null;
    @SuppressWarnings("unused")
   ...
   * @return the user return information
   */
  public R visit(final NodeToken n, final A a) {
    /* You have to adapt which data is returned (result variables below are just examples) */
    R r = null;
    @SuppressWarnings("unused")
    final String tkIm = n.tokenImage;
   ...
   * @return the user return information
   */
  public R visit(final JavaCCInput n, final A a) {
    R r = null;
    // f0 -> JavaCCOptions()
   ...
   * @return the user return information
   */
  public R visit(final JavaCCOptions n, final A a) {
    R r = null;
    // f0 -> [ #0 "options" #1 "{"
    // .. .. . #2 ( OptionBinding() )*
    // .. .. . #3 "}" ]
   ...
   * @return the user return information
   */
  public R visit(final OptionBinding n, final A a) {
    R r = null;
    // f0 -> ( %0 <IDENTIFIER>
    // .. .. | %1 "LOOKAHEAD"
    // .. .. | %2 "IGNORE_CASE"
   ...
   * @return the user return information
   */
  public R visit(final Production n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final JavaCodeProduction n, final A a) {
    R r = null;
    // f0 -> "JAVACODE"
   ...
   * @return the user return information
   */
  public R visit(final BNFProduction n, final A a) {
    R r = null;
    // f0 -> AccessModifier()
   ...
   * @return the user return information
   */
  public R visit(final AccessModifier n, final A a) {
    R r = null;
    // f0 -> ( %0 "public"
    // .. .. | %1 "protected"
    // .. .. | %2 "private"
   ...
   * @return the user return information
   */
  public R visit(final RegularExprProduction n, final A a) {
    R r = null;
    // f0 -> [ %0 #0 "<" #1 "*" #2 ">"
    // .. .. | %1 #0 "<" #1 <IDENTIFIER>
    // .. .. . .. #2 ( $0 "," $1 <IDENTIFIER> )*
   ...
   * @return the user return information
   */
  public R visit(final TokenManagerDecls n, final A a) {
    R r = null;
    // f0 -> "TOKEN_MGR_DECLS"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final RegExprKind n, final A a) {
    R r = null;
    // f0 -> . %0 "TOKEN"
    // .. .. | %1 "SPECIAL_TOKEN"
    // .. .. | %2 "SKIP"
   ...
   * @return the user return information
   */
  public R visit(final RegExprSpec n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ExpansionChoices n, final A a) {
    R r = null;
    // f0 -> Expansion()
   ...
   * @return the user return information
   */
  public R visit(final Expansion n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final LocalLookahead n, final A a) {
    R r = null;
    // f0 -> [ IntegerLiteral() ]
    final NodeOptional n0 = n.f0;
    final NodeOptional n0P = (NodeOptional) n0;
   ...
   * @return the user return information
   */
  public R visit(final ExpansionUnit n, final A a) {
    R r = null;
        ...
        switch (n0CHS2A1C.which) {
          case 0:
            ...
            if (n0CHS2A1CHS30A2P.present()) {
              r = n0CHS2A1CHS30A2P.accept(this, a);
            }
            break;
          case 1:
            // &1 $0 RegularExpression()
            ...
            r = n0CHS2A1CHS41A0.accept(this, a);
            // $1 [ ?0 "." ?1 <IDENTIFIER> ]
            ...
            if (n0CHS2A1CHS4A2P.present()) {
              r = n0CHS2A1CHS4A2P.accept(this, a);
            }
            break;
          default:
            // should not occur !!!
   ...
   * @return the user return information
   */
  public R visit(final ExpansionUnitTCF n, final A a) {
    R r = null;
    // f0 -> "try"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final RegularExpression n, final A a) {
    R r = null;
    // f0 -> . %0 StringLiteral()
    // .. .. | %1 #0 "<"
    // .. .. . .. #1 [ $0 [ "#" ]
   ...
   * @return the user return information
   */
  public R visit(final ComplexRegularExpressionChoices n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ComplexRegularExpressionUnit n, final A a) {
    R r = null;
    // f0 -> . %0 StringLiteral()
          ...
          switch (n0CHS13A3PC.which) {
            ...
            case 3:
              ...
              if (n0CHS13A3PCHS23A2P.present()) {
                ...
                r = n0CHS13A3PCHS23A2PS3A0.accept(this, a);
                // ?1 [ IntegerLiteral() ]
                ...
                if (n0CHS13A3PCHS23A2PS3A1P.present()) {
                  r = n0CHS13A3PCHS23A2PS3A1P.accept(this, a);
                }
              }
              // $3 "}"
              final INode n0CHS13A3PCHS2A3 = ((NodeSequence) n0CHS13A3PCHS2).elementAt(3);
              r = n0CHS13A3PCHS2A3.accept(this, a);
              break;
            default:
              // should not occur !!!
              break;
   ...
   * @return the user return information
   */
  public R visit(final CharacterList n, final A a) {
    R r = null;
    // f0 -> [ "~" ]
    final NodeOptional n0 = n.f0;
    final NodeOptional n0P = (NodeOptional) n0;
   ...
   * @return the user return information
   */
  public R visit(final CharacterDescriptor n, final A a) {
    R r = null;
    // f0 -> StringLiteral()
   ...
   * @return the user return information
   */
  public R visit(final IdentifierAsString n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final JavaIdentifier n, final A a) {
    R r = null;
    // f0 -> ( %00 <IDENTIFIER>
    // .. .. | %01 "LOOKAHEAD"
    // .. .. | %02 "IGNORE_CASE"
   ...
   * @return the user return information
   */
  public R visit(final CompilationUnit n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final PackageDeclaration n, final A a) {
    R r = null;
    // f0 -> "package"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ImportDeclaration n, final A a) {
    R r = null;
    // f0 -> "import"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final Modifiers n, final A a) {
    R r = null;
    // f0 -> ( ( %00 "public"
    // .. .. . | %01 "static"
    // .. .. . | %02 "protected"
   ...
   * @return the user return information
   */
  public R visit(final TypeDeclaration n, final A a) {
    R r = null;
    // f0 -> . %0 ";"
    // .. .. | %1 #0 Modifiers()
   ...
   * @return the user return information
   */
  public R visit(final ClassOrInterfaceDeclaration n, final A a) {
    R r = null;
    // f0 -> ( %0 "class"
    // .. .. | %1 "interface" )
    final NodeChoice n0 = n.f0;
   ...
   * @return the user return information
   */
  public R visit(final ExtendsList n, final A a) {
    R r = null;
    // f0 -> "extends"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ImplementsList n, final A a) {
    R r = null;
    // f0 -> "implements"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final EnumDeclaration n, final A a) {
    R r = null;
    // f0 -> "enum"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final EnumBody n, final A a) {
    R r = null;
    // f0 -> "{"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final EnumConstant n, final A a) {
    R r = null;
    // f0 -> Modifiers()
   ...
   * @return the user return information
   */
  public R visit(final TypeParameters n, final A a) {
    R r = null;
    // f0 -> "<"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final TypeParameter n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final TypeBound n, final A a) {
    R r = null;
    // f0 -> "extends"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ClassOrInterfaceBody n, final A a) {
    R r = null;
    // f0 -> "{"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ClassOrInterfaceBodyDeclaration n, final A a) {
    R r = null;
    // f0 -> . %0 Initializer()
    // .. .. | %1 #0 Modifiers()
    // .. .. . .. #1 ( &0 ClassOrInterfaceDeclaration()
   ...
   * @return the user return information
   */
  public R visit(final FieldDeclaration n, final A a) {
    R r = null;
    // f0 -> Type()
    final Type n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final VariableDeclarator n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final VariableDeclaratorId n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final VariableInitializer n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ArrayInitializer n, final A a) {
    R r = null;
    // f0 -> "{"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final MethodDeclaration n, final A a) {
    R r = null;
    // f0 -> [ TypeParameters() ]
    final NodeOptional n0 = n.f0;
    final NodeOptional n0P = (NodeOptional) n0;
   ...
   * @return the user return information
   */
  public R visit(final MethodDeclarator n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final FormalParameters n, final A a) {
    R r = null;
    // f0 -> "("
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final FormalParameter n, final A a) {
    R r = null;
    // f0 -> Modifiers()
    final Modifiers n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ConstructorDeclaration n, final A a) {
    R r = null;
    // f0 -> [ TypeParameters() ]
    final NodeOptional n0 = n.f0;
    final NodeOptional n0P = (NodeOptional) n0;
   ...
   * @return the user return information
   */
  public R visit(final ExplicitConstructorInvocation n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final Initializer n, final A a) {
    R r = null;
    // f0 -> [ "static" ]
    final NodeOptional n0 = n.f0;
    final NodeOptional n0P = (NodeOptional) n0;
   ...
   * @return the user return information
   */
  public R visit(final Type n, final A a) {
    R r = null;
    // f0 -> . %0 ReferenceType()
    // .. .. | %1 PrimitiveType()
    final NodeChoice n0C = n.f0;
   ...
   * @return the user return information
   */
  public R visit(final ReferenceType n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ClassOrInterfaceType n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final TypeArguments n, final A a) {
    R r = null;
    // f0 -> "<"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final TypeArgument n, final A a) {
    R r = null;
    // f0 -> . %0 ReferenceType()
    // .. .. | %1 #0 "?"
    // .. .. . .. #1 [ WildcardBounds() ]
   ...
   * @return the user return information
   */
  public R visit(final WildcardBounds n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final PrimitiveType n, final A a) {
    R r = null;
    // f0 -> . %0 "boolean"
    // .. .. | %1 "char"
    // .. .. | %2 "byte"
   ...
   * @return the user return information
   */
  public R visit(final ResultType n, final A a) {
    R r = null;
    // f0 -> ( %0 "void"
    // .. .. | %1 Type() )
    final NodeChoice n0 = n.f0;
   ...
   * @return the user return information
   */
  public R visit(final Name n, final A a) {
    R r = null;
    // f0 -> JavaIdentifier()
   ...
   * @return the user return information
   */
  public R visit(final NameList n, final A a) {
    R r = null;
    // f0 -> Name()
    final Name n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final Expression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final AssignmentOperator n, final A a) {
    R r = null;
    // f0 -> . %00 "="
    // .. .. | %01 "*="
    // .. .. | %02 "/="
   ...
   * @return the user return information
   */
  public R visit(final ConditionalExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ConditionalOrExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ConditionalAndExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final InclusiveOrExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ExclusiveOrExpression n, final A a) {
    R r = null;
    // f0 -> AndExpression()
   ...
   * @return the user return information
   */
  public R visit(final AndExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final EqualityExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final InstanceOfExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final RelationalExpression n, final A a) {
    R r = null;
    // f0 -> ShiftExpression()
   ...
   * @return the user return information
   */
  public R visit(final ShiftExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final RSignedShift n, final A a) {
    R r = null;
    // f0 -> ">>"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final RUnsignedShift n, final A a) {
    R r = null;
    // f0 -> ">>>"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final AdditiveExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final MultiplicativeExpression n, final A a) {
    R r = null;
    // f0 -> UnaryExpression()
   ...
   * @return the user return information
   */
  public R visit(final UnaryExpression n, final A a) {
    R r = null;
    // f0 -> . %0 #0 ( &0 "+"
    // .. .. . .. .. | &1 "-" )
    // .. .. . .. #1 UnaryExpression()
   ...
   * @return the user return information
   */
  public R visit(final PreIncrementExpression n, final A a) {
    R r = null;
    // f0 -> "++"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final PreDecrementExpression n, final A a) {
    R r = null;
    // f0 -> "--"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final UnaryExpressionNotPlusMinus n, final A a) {
    R r = null;
    // f0 -> . %0 #0 ( &0 "~"
    // .. .. . .. .. | &1 "!" )
    // .. .. . .. #1 UnaryExpression()
   ...
   * @return the user return information
   */
  public R visit(final CastLookahead n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final PostfixExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final CastExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final PrimaryExpression n, final A a) {
    R r = null;
    // f0 -> PrimaryPrefix()
   ...
   * @return the user return information
   */
  public R visit(final MemberSelector n, final A a) {
    R r = null;
    // f0 -> "."
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final PrimaryPrefix n, final A a) {
    R r = null;
    // f0 -> . %0 Literal()
    // .. .. | %1 "this"
   ...
   * @return the user return information
   */
  public R visit(final PrimarySuffix n, final A a) {
    R r = null;
    // f0 -> . %0 #0 "." #1 "this"
   ...
   * @return the user return information
   */
  public R visit(final Literal n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final IntegerLiteral n, final A a) {
    R r = null;
    // f0 -> <INTEGER_LITERAL>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final BooleanLiteral n, final A a) {
    R r = null;
    // f0 -> . %0 "true"
    // .. .. | %1 "false"
    final NodeChoice n0C = n.f0;
   ...
   * @return the user return information
   */
  public R visit(final StringLiteral n, final A a) {
    R r = null;
    // f0 -> <STRING_LITERAL>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final NullLiteral n, final A a) {
    R r = null;
    // f0 -> "null"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final Arguments n, final A a) {
    R r = null;
    // f0 -> "("
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ArgumentList n, final A a) {
    R r = null;
    // f0 -> Expression()
   ...
   * @return the user return information
   */
  public R visit(final AllocationExpression n, final A a) {
    R r = null;
      ...
      case 1:
        ...
        switch (n0CHS1A3C.which) {
          ...
          case 1:
            ...
            r = n0CHS1A3CHS21A0.accept(this, a);
            // $1 [ ClassOrInterfaceBody() ]
            ...
            if (n0CHS1A3CHS21A1P.present()) {
              r = n0CHS1A3CHS21A1P.accept(this, a);
            }
            break;
          default:
            // should not occur !!!
   ...
   * @return the user return information
   */
  public R visit(final ArrayDimsAndInits n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final Statement n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final AssertStatement n, final A a) {
    R r = null;
    // f0 -> "assert"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final LabeledStatement n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final Block n, final A a) {
    R r = null;
    // f0 -> "{"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final BlockStatement n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final LocalVariableDeclaration n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final VariableModifiers n, final A a) {
    R r = null;
    // f0 -> ( ( %0 "final"
    // .. .. . | %1 Annotation() ) )*
    final NodeListOptional n0 = n.f0;
   ...
   * @return the user return information
   */
  public R visit(final EmptyStatement n, final A a) {
    R r = null;
    // f0 -> ";"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final StatementExpression n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final SwitchStatement n, final A a) {
    R r = null;
    // f0 -> "switch"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final SwitchLabel n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final IfStatement n, final A a) {
    R r = null;
    // f0 -> "if"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final WhileStatement n, final A a) {
    R r = null;
    // f0 -> "while"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final DoStatement n, final A a) {
    R r = null;
    // f0 -> "do"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ForStatement n, final A a) {
    R r = null;
    // f0 -> "for"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ForInit n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final StatementExpressionList n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final ForUpdate n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final BreakStatement n, final A a) {
    R r = null;
    // f0 -> "break"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ContinueStatement n, final A a) {
    R r = null;
    // f0 -> "continue"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ReturnStatement n, final A a) {
    R r = null;
    // f0 -> "return"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final ThrowStatement n, final A a) {
    R r = null;
    // f0 -> "throw"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final SynchronizedStatement n, final A a) {
    R r = null;
    // f0 -> "synchronized"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final TryStatement n, final A a) {
    R r = null;
    // f0 -> "try"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final Annotation n, final A a) {
    R r = null;
   ...
   * @return the user return information
   */
  public R visit(final NormalAnnotation n, final A a) {
    R r = null;
    // f0 -> "@"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final MarkerAnnotation n, final A a) {
    R r = null;
    // f0 -> "@"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final SingleMemberAnnotation n, final A a) {
    R r = null;
    // f0 -> "@"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final MemberValuePairs n, final A a) {
    R r = null;
    // f0 -> MemberValuePair()
   ...
   * @return the user return information
   */
  public R visit(final MemberValuePair n, final A a) {
    R r = null;
    // f0 -> <IDENTIFIER>
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final MemberValue n, final A a) {
    R r = null;
    // f0 -> . %0 Annotation()
   ...
   * @return the user return information
   */
  public R visit(final MemberValueArrayInitializer n, final A a) {
    R r = null;
    // f0 -> "{"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final AnnotationTypeDeclaration n, final A a) {
    R r = null;
    // f0 -> "@"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final AnnotationTypeBody n, final A a) {
    R r = null;
    // f0 -> "{"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final AnnotationTypeMemberDeclaration n, final A a) {
    R r = null;
    // f0 -> . %0 #0 Modifiers()
        ...
        switch (n0CHS00A1C.which) {
          case 0:
            ...
            if (n0CHS00A1CHS10A4P.present()) {
              r = n0CHS00A1CHS10A4P.accept(this, a);
            }
            // $5 ";"
            final INode n0CHS00A1CHS1A5 = ((NodeSequence) n0CHS00A1CHS1).elementAt(5);
            r = n0CHS00A1CHS1A5.accept(this, a);
            break;
          case 1:
            // &1 ClassOrInterfaceDeclaration()
            r = n0CHS00A1CH.accept(this, a);
            break;
          case 2:
            // &2 EnumDeclaration()
            r = n0CHS00A1CH.accept(this, a);
   ...
   * @return the user return information
   */
  public R visit(final DefaultValue n, final A a) {
    R r = null;
    // f0 -> "default"
    final NodeToken n0 = n.f0;
    r = n0.accept(this, a);
