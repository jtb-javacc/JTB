...
/**
 * JTB node class for the production Arguments:<br>
...
public class Arguments implements INode {
   ...
   */
  public Arguments(final NodeToken n0, final NodeOptional n1, final NodeToken n2) {
    f0 = n0;
    f1 = n1;
    f2 = n2;
  }
   ...
   * @param n0 first child node
   */
  public Arguments(final NodeOptional n0) {
    f0 = new NodeToken("(");
    f1 = n0;
    f2 = new NodeToken(")");
  }
