...
public class DepthFirstRetVisitor<R> implements IRetVisitor<R> {
    ...
    if (n0.present()) {
      ...
      if (n0S0A2T.present()) {
        for (int i = 0; i < n0S0A2T.size(); i++) {
          ...
          nRes = n0S0A2TMi.accept(this);
        }
      }
      // #3 "}"
      final INode n0S0A3 = n0S0.elementAt(3);
      nRes = n0S0A3.accept(this);
    }
    return nRes;
  }
    ...
    if (n5.present()) {
      ...
      if (n5S0A2T.present()) {
        for (int i = 0; i < n5S0A2T.size(); i++) {
          ...
          nRes = n5S0A2TMiS1A0.accept(this);
          // $1 Name()
          final INode n5S0A2TMiS1A1 = n5S0A2TMiS1.elementAt(1);
          nRes = n5S0A2TMiS1A1.accept(this);
        }
      }
    }
    // f6 -> Block()
  ...
  public R visit(final BNFProduction n) {
    ...
    if (n4.present()) {
      ...
      nRes = n4S0A0.accept(this);
      // #1 Name()
      final INode n4S0A1 = n4S0.elementAt(1);
      nRes = n4S0A1.accept(this);
      // #2 ( $0 "," $1 Name() )*
      ...
      if (n4S0A2T.present()) {
        for (int i = 0; i < n4S0A2T.size(); i++) {
          ...
          nRes = n4S0A2TMiS1A0.accept(this);
          // $1 Name()
          final INode n4S0A2TMiS1A1 = n4S0A2TMiS1.elementAt(1);
          nRes = n4S0A2TMiS1A1.accept(this);
        }
      }
    }
    // f5 -> ":"
  ...
  public R visit(final RegularExprProduction n) {
        ...
        case 1:
          ...
          if (n0CHS1A2T.present()) {
            for (int i = 0; i < n0CHS1A2T.size(); i++) {
              ...
              nRes = n0CHS1A2TMiS2A0.accept(this);
              // $1 < IDENTIFIER >
              final INode n0CHS1A2TMiS2A1 = n0CHS1A2TMiS2.elementAt(1);
              nRes = n0CHS1A2TMiS2A1.accept(this);
            }
          }
          // #3 ">"
    ...
    if (n6.present()) {
      for (int i = 0; i < n6.size(); i++) {
        ...
        nRes = n6MiS0A0.accept(this);
        // #1 RegExprSpec()
        final INode n6MiS0A1 = n6MiS0.elementAt(1);
        nRes = n6MiS0A1.accept(this);
      }
    }
    // f7 -> "}"
    final NodeToken n7 = n.f7;
    ...
    switch (n0C.which) {
      ...
      case 4:
        ...
        if (n0CHS2A0P.present()) {
          ...
          nRes = n0CHS2A0PS3A0.accept(this);
          // $1 "="
          final INode n0CHS2A0PS3A1 = n0CHS2A0PS3.elementAt(1);
          nRes = n0CHS2A0PS3A1.accept(this);
        }
        // #1 ( &0 $0 IdentifierAsString() $1 Arguments()
        // .. | &1 $0 RegularExpression()
        // .. .. $1 [ ?0 "." ?1 < IDENTIFIER > ] )
        ...
        switch (n0CHS2A1C.which) {
          case 0:
            ...
            nRes = n0CHS2A1CHS3A0.accept(this);
            // $1 Arguments()
            final INode n0CHS2A1CHS3A1 = n0CHS2A1CHS3.elementAt(1);
            nRes = n0CHS2A1CHS3A1.accept(this);
            break;
          case 1:
            // &1 $0 RegularExpression()
            // .. $1 [ ?0 "." ?1 < IDENTIFIER > ]
            ...
            nRes = n0CHS2A1CHS4A0.accept(this);
            // $1 [ ?0 "." ?1 < IDENTIFIER > ]
            ...
            if (n0CHS2A1CHS4A1P.present()) {
              ...
              nRes = n0CHS2A1CHS4A1PS5A0.accept(this);
              // ?1 < IDENTIFIER >
              final INode n0CHS2A1CHS4A1PS5A1 = n0CHS2A1CHS4A1PS5.elementAt(1);
              nRes = n0CHS2A1CHS4A1PS5A1.accept(this);
            }
            break;
          default:
            // should not occur !!!
  ...
  public R visit(final ExpansionUnitTCF n) {
    ...
    if (n4.present()) {
      for (int i = 0; i < n4.size(); i++) {
        ...
        nRes = n4MiS0A0.accept(this);
        // #1 "("
        final INode n4MiS0A1 = n4MiS0.elementAt(1);
        nRes = n4MiS0A1.accept(this);
        // #2 Name()
        ...
        nRes = n4MiS0A4.accept(this);
        // #5 Block()
        final INode n4MiS0A5 = n4MiS0.elementAt(5);
        nRes = n4MiS0A5.accept(this);
      }
    }
        ...
        if (n0CHS1A3P.present()) {
          ...
          switch (n0CHS1A3PC.which) {
            ...
            case 3:
              ...
              nRes = n0CHS1A3PCHS2A0.accept(this);
              // $1 IntegerLiteral()
              final INode n0CHS1A3PCHS2A1 = n0CHS1A3PCHS2.elementAt(1);
              nRes = n0CHS1A3PCHS2A1.accept(this);
              // $2 [ ?0 ","
              // .. . ?1 [ IntegerLiteral() ] ]
              ...
              if (n0CHS1A3PCHS2A2P.present()) {
                ...
                nRes = n0CHS1A3PCHS2A2PS3A0.accept(this);
                // ?1 [ IntegerLiteral() ]
                ...
                if (n0CHS1A3PCHS2A2PS3A1P.present()) {
                  nRes = n0CHS1A3PCHS2A2PS3A1P.accept(this);
                }
              }
              // $3 "}"
              final INode n0CHS1A3PCHS2A3 = n0CHS1A3PCHS2.elementAt(3);
              nRes = n0CHS1A3PCHS2A3.accept(this);
              break;
            default:
              // should not occur !!!
              break;
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        if (n0CHS1A0P.present()) {
          ...
          nRes = n0CHS1A0PS2A0.accept(this);
          // $1 "."
          final INode n0CHS1A0PS2A1 = n0CHS1A0PS2.elementAt(1);
          nRes = n0CHS1A0PS2A1.accept(this);
        }
        // #1 "super"
        final INode n0CHS1A1 = n0CHS1.elementAt(1);
        nRes = n0CHS1A1.accept(this);
      ...
      case 1:
        ...
        if (n0CHS1A1T.present()) {
          for (int i = 0; i < n0CHS1A1T.size(); i++) {
            ...
            nRes = n0CHS1A1TMiS2A0.accept(this);
            // $1 "]"
            final INode n0CHS1A1TMiS2A1 = n0CHS1A1TMiS2.elementAt(1);
            nRes = n0CHS1A1TMiS2A1.accept(this);
          }
        }
        break;
      default:
      ...
      case 1:
        ...
        switch (n0CHS1A3C.which) {
          ...
          case 1:
            ...
            nRes = n0CHS1A3CHS2A0.accept(this);
            // $1 [ ClassOrInterfaceBody() ]
            ...
            if (n0CHS1A3CHS2A1P.present()) {
              nRes = n0CHS1A3CHS2A1P.accept(this);
            }
            break;
          default:
            // should not occur !!!
      ...
      case 0:
        ...
        if (n0CHS0A1T.present()) {
          for (int i = 0; i < n0CHS0A1T.size(); i++) {
            ...
            nRes = n0CHS0A1TMiS1A0.accept(this);
            // $1 "]"
            final INode n0CHS0A1TMiS1A1 = n0CHS0A1TMiS1.elementAt(1);
            nRes = n0CHS0A1TMiS1A1.accept(this);
          }
        }
        break;
      case 1:
        ...
        for (int i = 0; i < n0CHS1A0L1.size(); i++) {
          ...
          nRes = n0CHS1A0L1EiS2A0.accept(this);
          // $1 "]"
          final INode n0CHS1A0L1EiS2A1 = n0CHS1A0L1EiS2.elementAt(1);
          nRes = n0CHS1A0L1EiS2A1.accept(this);
        }
        // #1 ArrayInitializer()
        final INode n0CHS1A1 = n0CHS1.elementAt(1);
        nRes = n0CHS1A1.accept(this);
        ...
        if (n0CHS0A1P.present()) {
          ...
          switch (n0CHS0A1PC.which) {
            ...
            case 2:
              ...
              nRes = n0CHS0A1PCHS1A0.accept(this);
              // $1 Expression()
              final INode n0CHS0A1PCHS1A1 = n0CHS0A1PCHS1.elementAt(1);
              nRes = n0CHS0A1PCHS1A1.accept(this);
              break;
            default:
              // should not occur !!!
              break;
        ...
        switch (n0CHS0A1C.which) {
          case 0:
            ...
            if (n0CHS0A1CHS1A4P.present()) {
              nRes = n0CHS0A1CHS1A4P.accept(this);
            }
            // $5 ";"
