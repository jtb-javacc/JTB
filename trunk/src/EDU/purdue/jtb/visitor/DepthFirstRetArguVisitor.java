  ...
  public R visit(final ExpansionUnit n, final A argu) {
    ...
    switch (n0C.which) {
      case 0:
        ...
        nRes = n0CHS00A3.accept(this, argu);
        break;
      case 1:
        // %1 Block()
        nRes = n0CH.accept(this, argu);
      ...
      case 2:
        ...
        nRes = n0CHS12A0.accept(this, argu);
        // #1 ExpansionChoices()
        final INode n0CHS12A1 = n0CHS1.elementAt(1);
        nRes = n0CHS12A1.accept(this, argu);
        // #2 "]"
        final INode n0CHS12A2 = n0CHS1.elementAt(2);
        nRes = n0CHS12A2.accept(this, argu);
        break;
      case 3:
        // %3 ExpansionUnitTCF()
        nRes = n0CH.accept(this, argu);
      ...
      case 4:
        ...
        if (n0CHS24A0P.present()) {
          ...
          nRes = n0CHS24A0PS3A0.accept(this, argu);
          // $1 "="
        ...
        switch (n0CHS2A1C.which) {
          case 0:
            ...
            nRes = n0CHS2A1CHS30A0.accept(this, argu);
            // $1 Arguments()
      ...
      case 5:
        ...
        nRes = n0CHS35A0.accept(this, argu);
        // #1 ExpansionChoices()
        final INode n0CHS35A1 = n0CHS3.elementAt(1);
        nRes = n0CHS35A1.accept(this, argu);
        // #2 ")"
        final INode n0CHS35A2 = n0CHS3.elementAt(2);
        nRes = n0CHS35A2.accept(this, argu);
        // #3 ( &0 "+"
        // .. | &1 "*"
        // .. | &2 "?" )?
        ...
        if (n0CHS35A3P.present()) {
          ...
          switch (n0CHS35A3PC.which) {
            case 0:
              // &0 "+"
              nRes = n0CHS35A3PCH.accept(this, argu);
              break;
            case 1:
              // &1 "*"
              nRes = n0CHS35A3PCH.accept(this, argu);
  ...
  public R visit(final RegularExpression n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 3:
        ...
        nRes = n0CHS23A0.accept(this, argu);
        // #1 "EOF"
        final INode n0CHS23A1 = n0CHS2.elementAt(1);
        nRes = n0CHS23A1.accept(this, argu);
        // #2 ">"
      ...
      case 3:
        ...
        if (n0CHS13A3P.present()) {
          ...
          switch (n0CHS13A3PC.which) {
            case 0:
              // &0 "+"
              nRes = n0CHS13A3PCH.accept(this, argu);
              break;
            case 1:
              // &1 "*"
              nRes = n0CHS13A3PCH.accept(this, argu);
            ...
            case 3:
              ...
              nRes = n0CHS13A3PCHS23A0.accept(this, argu);
              // $1 IntegerLiteral()
              final INode n0CHS13A3PCHS23A1 = n0CHS13A3PCHS2.elementAt(1);
              nRes = n0CHS13A3PCHS23A1.accept(this, argu);
              // $2 [ ?0 ","
              // .. . ?1 [ IntegerLiteral() ] ]
              ...
              if (n0CHS13A3PCHS23A2P.present()) {
                ...
                nRes = n0CHS13A3PCHS23A2PS3A0.accept(this, argu);
                // ?1 [ IntegerLiteral() ]
                ...
                if (n0CHS13A3PCHS23A2PS3A1P.present()) {
                  nRes = n0CHS13A3PCHS23A2PS3A1P.accept(this, argu);
                }
              }
              // $3 "}"
              final INode n0CHS13A3PCHS2A3 = n0CHS13A3PCHS2.elementAt(3);
              nRes = n0CHS13A3PCHS2A3.accept(this, argu);
              break;
            default:
              // should not occur !!!
              break;
      ...
      case 1:
        ...
        switch (n0CHS01A1C.which) {
          case 0:
            ...
            nRes = n0CHS01A1CH.accept(this, argu);
            break;
          case 1:
            // &1 EnumDeclaration()
            nRes = n0CHS01A1CH.accept(this, argu);
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        if (n0CHS11A0P.present()) {
          ...
          nRes = n0CHS11A0PS2A0.accept(this, argu);
          // $1 "."
          final INode n0CHS11A0PS2A1 = n0CHS11A0PS2.elementAt(1);
          nRes = n0CHS11A0PS2A1.accept(this, argu);
        }
        // #1 "super"
    ...
    switch (n0C.which) {
      case 0:
        ...
        for (int i = 0; i < n0CHS00A1L.size(); i++) {
          ...
          nRes = n0CHS00A1LEiS1A0.accept(this, argu);
          // $1 "]"
          final INode n0CHS00A1LEiS1A1 = n0CHS00A1LEiS1.elementAt(1);
          nRes = n0CHS00A1LEiS1A1.accept(this, argu);
        }
        break;
      case 1:
        // %1 #0 ClassOrInterfaceType()
        ...
        if (n0CHS11A1T.present()) {
          for (int i = 0; i < n0CHS11A1T.size(); i++) {
            ...
            nRes = n0CHS11A1TMiS2A0.accept(this, argu);
            // $1 "]"
            final INode n0CHS11A1TMiS2A1 = n0CHS11A1TMiS2.elementAt(1);
            nRes = n0CHS11A1TMiS2A1.accept(this, argu);
          }
        }
        break;
      default:
  ...
  public R visit(final TypeArgument n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        final NodeOptional n0CHS01A1P = (NodeOptional) n0CHS01A1;
        if (n0CHS01A1P.present()) {
          nRes = n0CHS01A1P.accept(this, argu);
        }
        break;
      default:
        // should not occur !!!
  ...
  public R visit(final RelationalExpression n, final A argu) {
    ...
    if (n1.present()) {
      for (int i = 0; i < n1.size(); i++) {
        ...
        nRes = n1MiS03A1.accept(this, argu);
      }
    }
    return nRes;
  }
  ...
  public R visit(final ShiftExpression n, final A argu) {
    ...
    if (n1.present()) {
      for (int i = 0; i < n1.size(); i++) {
        ...
        nRes = n1MiS02A1.accept(this, argu);
      }
    }
    return nRes;
  }
  ...
  public R visit(final CastLookahead n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        nRes = n0CHS11A3.accept(this, argu);
        break;
      case 2:
        // %2 #0 "(" #1 Type() #2 ")"
        // .. #3 ( &0 "~"
        ...
        nRes = n0CHS22A0.accept(this, argu);
        // #1 Type()
        final INode n0CHS22A1 = n0CHS2.elementAt(1);
        nRes = n0CHS22A1.accept(this, argu);
        // #2 ")"
        final INode n0CHS22A2 = n0CHS2.elementAt(2);
        nRes = n0CHS22A2.accept(this, argu);
        // #3 ( &0 "~"
        // .. | &1 "!"
        // .. | &2 "("
        // .. | &3 <IDENTIFIER>
  ...
  public R visit(final PrimaryPrefix n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 2:
        ...
        nRes = n0CHS02A0.accept(this, argu);
        // #1 "."
      ...
      case 5:
        ...
        nRes = n0CHS25A0.accept(this, argu);
        // #1 "."
        final INode n0CHS25A1 = n0CHS2.elementAt(1);
        nRes = n0CHS25A1.accept(this, argu);
        // #2 "class"
        final INode n0CHS25A2 = n0CHS2.elementAt(2);
        nRes = n0CHS25A2.accept(this, argu);
        break;
      case 6:
        // %6 Name()
        nRes = n0CH.accept(this, argu);
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        if (n0CHS11A2P.present()) {
          nRes = n0CHS11A2P.accept(this, argu);
        }
        // #3 ( &0 ArrayDimsAndInits()
        // .. | &1 $0 Arguments()
        // .. .. $1 [ ClassOrInterfaceBody() ] )
        ...
        switch (n0CHS1A3C.which) {
          ...
          case 1:
            ...
            nRes = n0CHS1A3CHS21A0.accept(this, argu);
            // $1 [ ClassOrInterfaceBody() ]
            ...
            if (n0CHS1A3CHS21A1P.present()) {
              nRes = n0CHS1A3CHS21A1P.accept(this, argu);
            }
            break;
          default:
            // should not occur !!!
    ...
    switch (n0C.which) {
      case 0:
        ...
        for (int i = 0; i < n0CHS00A0L.size(); i++) {
          ...
          nRes = n0CHS00A0LEiS1A0.accept(this, argu);
          // $1 Expression()
          final INode n0CHS00A0LEiS1A1 = n0CHS00A0LEiS1.elementAt(1);
          nRes = n0CHS00A0LEiS1A1.accept(this, argu);
          // $2 "]"
          final INode n0CHS00A0LEiS1A2 = n0CHS00A0LEiS1.elementAt(2);
          nRes = n0CHS00A0LEiS1A2.accept(this, argu);
        }
        // #1 ( $0 "[" $1 "]" )*
      ...
      case 1:
        ...
        for (int i = 0; i < n0CHS11A0L1.size(); i++) {
          ...
          nRes = n0CHS11A0L1EiS2A0.accept(this, argu);
          // $1 "]"
          final INode n0CHS11A0L1EiS2A1 = n0CHS11A0L1EiS2.elementAt(1);
          nRes = n0CHS11A0L1EiS2A1.accept(this, argu);
        }
        // #1 ArrayInitializer()
        final INode n0CHS1A1 = n0CHS1.elementAt(1);
        nRes = n0CHS1A1.accept(this, argu);
  ...
  public R visit(final Statement n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 4:
        ...
        nRes = n0CHS04A0.accept(this, argu);
        // #1 ";"
        final INode n0CHS04A1 = n0CHS0.elementAt(1);
        nRes = n0CHS04A1.accept(this, argu);
        break;
      case 5:
        // %05 SwitchStatement()
        nRes = n0CH.accept(this, argu);
      ...
      case 2:
        ...
        if (n0CHS02A1P.present()) {
          ...
          switch (n0CHS02A1PC.which) {
            case 0:
              // &0 "++"
              nRes = n0CHS02A1PCH.accept(this, argu);
              break;
            case 1:
              // &1 "--"
              nRes = n0CHS02A1PCH.accept(this, argu);
            ...
            case 2:
              ...
              nRes = n0CHS02A1PCHS12A0.accept(this, argu);
              // $1 Expression()
              final INode n0CHS02A1PCHS12A1 = n0CHS02A1PCHS1.elementAt(1);
              nRes = n0CHS02A1PCHS12A1.accept(this, argu);
              break;
            default:
              // should not occur !!!
              break;
  ...
  public R visit(final ForStatement n, final A argu) {
    ...
    switch (n2C.which) {
      case 0:
        ...
        nRes = n2CHS00A0.accept(this, argu);
        // #1 Type()
        ...
        nRes = n2CHS00A3.accept(this, argu);
        // #4 Expression()
        final INode n2CHS00A4 = n2CHS0.elementAt(4);
        nRes = n2CHS00A4.accept(this, argu);
        break;
      case 1:
        // %1 #0 [ ForInit() ]
        // .. #1 ";"
        ...
        if (n2CHS11A0P.present()) {
          nRes = n2CHS11A0P.accept(this, argu);
        }
        // #1 ";"
      ...
      case 0:
        ...
        switch (n0CHS00A1C.which) {
          case 0:
            ...
            nRes = n0CHS00A1CHS10A2.accept(this, argu);
            // $3 ")"
            final INode n0CHS00A1CHS10A3 = n0CHS00A1CHS1.elementAt(3);
            nRes = n0CHS00A1CHS10A3.accept(this, argu);
            // $4 [ DefaultValue() ]
            ...
            if (n0CHS00A1CHS10A4P.present()) {
              nRes = n0CHS00A1CHS10A4P.accept(this, argu);
            }
            // $5 ";"
            final INode n0CHS00A1CHS1A5 = n0CHS00A1CHS1.elementAt(5);
            nRes = n0CHS00A1CHS1A5.accept(this, argu);
            break;
          case 1:
            // &1 ClassOrInterfaceDeclaration()
            nRes = n0CHS00A1CH.accept(this, argu);
            break;
          case 2:
            // &2 EnumDeclaration()
            nRes = n0CHS00A1CH.accept(this, argu);
