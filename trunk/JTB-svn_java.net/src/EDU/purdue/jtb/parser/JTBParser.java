...
public class JTBParser extends JavaCCParserInternals implements JTBParserConstants {
  ...
  /** Return variable for {@link #Identifier} production */
  String jtbrt_Identifier;
 ...
 ************************************************/
// ModMMa: added to test try-expansion_choices-catch-finally syntax
  final public AFancyProduction AFancyProduction() throws ParseException {
  // --- JTB generated node declarations ---
  NodeSequence n0 = null;
  NodeListOptional n1 = new NodeListOptional();
  Annotation n2 = null;
  NodeChoice n3 = null;
  LabeledStatement n4 = null;
  AssertStatement n5 = null;
  Block n6 = null;
  EmptyStatement n7 = null;
  NodeSequence n8 = null;
  StatementExpression n9 = null;
  NodeToken n10 = null;
  Token n11 = null;
  SwitchStatement n12 = null;
  TryStatement n13 = null;
  NodeOptional n14 = new NodeOptional();
  MarkerAnnotation n15 = null;
    try {
      ...
      if (jj_2_1(2)) {
        ...
        case ASSERT:
          n5 = AssertStatement();
            n3 = new NodeChoice(n5, 1, 7);
          break;
        case LBRACE:
          n6 = Block(null);
            n3 = new NodeChoice(n6, 2, 7);
          break;
        case SEMICOLON:
          n7 = EmptyStatement();
            n3 = new NodeChoice(n7, 3, 7);
          break;
        case _LOOKAHEAD:
        case _IGNORE_CASE:
        case _PARSER_BEGIN:
        ...
        case IDENTIFIER:
          ...
          n9 = StatementExpression();
            n8.addNode(n9);
          n11 = jj_consume_token(SEMICOLON);
            n10 = JTBToolkit.makeNodeToken(n11);
            n8.addNode(n10);
            n3 = new NodeChoice(n8, 4, 7);
          break;
        case SWITCH:
          n12 = SwitchStatement();
            n3 = new NodeChoice(n12, 5, 7);
          break;
        case TRY:
          n13 = TryStatement();
            n3 = new NodeChoice(n13, 6, 7);
          break;
        default:
          jj_la1[1] = jj_gen;
          jj_consume_token(-1);
      ...
      default:
        ...
        n0.addNode(n14);
    } catch (Exception fancy_e) {
    fancy_e = null;
    } catch (Throwable fancy_t) {
    fancy_t = null;
    } finally {
    String fancy_s = "";
    if (fancy_s == " ")
  ...
  //      ls = null;
    ...
    {if (true) return new AFancyProduction(n0);}
...
// MMa : changed all javacc_input into JavaCCInput to conform to class name convention
  ...
  Options.init();
    ...
    {if (true) return new JavaCCInput(n0, n1, n3, n5, n6, n8, n9, n11, n13, n14, n16);}
    throw new Error("Missing return statement in function");
  }
...
// MMa : changed all bnf_production into BNFProduction to conform to class name convention
  ...
  jumpPatched = false;
    ...
    n14 = JTBToolkit.makeNodeToken(n15);
    n16 = Block(p.getDeclarationTokens());
    n18 = jj_consume_token(LBRACE);
    n17 = JTBToolkit.makeNodeToken(n18);
    n19 = ExpansionChoices(c);
    ...
    addproduction(p);
    {if (true) return new BNFProduction(n0, n1, n2, n3, n4, n14, n16, n17, n19, n20);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token t = null;
    ...
    case PUBLIC:
      ...
      case PROTECTED:
        ...
        n4 = JTBToolkit.makeNodeToken(n5);
        t = n5;
        n1 = new NodeChoice(n4, 1, 3);
        break;
      case PRIVATE:
        n7 = jj_consume_token(PRIVATE);
        n6 = JTBToolkit.makeNodeToken(n7);
        t = n7;
        n1 = new NodeChoice(n6, 2, 3);
        break;
      default:
        jj_la1[12] = jj_gen;
        jj_consume_token(-1);
  ...
  p.setColumn(t.beginColumn);
    ...
    case LANGLE:
      ...
      if (jj_2_2(2)) {
        ...
        n4 = jj_consume_token(LANGLE);
        n3 = JTBToolkit.makeNodeToken(n4);
        n2.addNode(n3);
        n6 = jj_consume_token(STAR);
        n5 = JTBToolkit.makeNodeToken(n6);
        n2.addNode(n5);
        n8 = jj_consume_token(RANGLE);
        n7 = JTBToolkit.makeNodeToken(n8);
        n2.addNode(n7);
        p.lexStates = null;
        ...
        n9.addNode(n14);
          n21 = jj_consume_token(RANGLE);
        n20 = JTBToolkit.makeNodeToken(n21);
        n9.addNode(n20);
        p.lexStates = new String[states.size()];
        for (int i = 0; // ModMMa : workaround for sf plugin color syntaxing problem
        //      i < states.size();
        i != states.size(); i++) {
...
// MMa : changed all expansion_unit into ExpansionUnit to conform to class name convention
   ...
   */
    ...
    default:
      ...
      t = n37;
      n35.addNode(n36);
          n38 = ExpansionChoices(c);
      n35.addNode(n38);
          n40 = jj_consume_token(RPAREN);
      ...
      n35.addNode(n39);
          ...
          n42 = new NodeChoice(n43, 0, 3);
              break;
            case STAR:
              n46 = jj_consume_token(STAR);
          n45 = JTBToolkit.makeNodeToken(n46);
          c.member = new ZeroOrMore(t, (Expansion_)c.member);
          n42 = new NodeChoice(n45, 1, 3);
              break;
            case HOOK:
              n48 = jj_consume_token(HOOK);
          n47 = JTBToolkit.makeNodeToken(n48);
          c.member = new ZeroOrOne(t, (Expansion_)c.member);
          n42 = new NodeChoice(n47, 2, 3);
              break;
            default:
              jj_la1[27] = jj_gen;
              jj_consume_token(-1);
...
// MMa : added to create a node
  final public ExpansionUnitInTCF ExpansionUnitInTCF(Container c) throws ParseException {
  // --- JTB generated node declarations ---
  NodeToken n0 = null;
  Token n1 = null;
  NodeToken n2 = null;
  ...
  Token t;
    ...
    {if (true) return new ExpansionUnitInTCF(n0, n2, n4, n5, n7, n19);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token t = getToken(1);
    ...
    default:
      ...
      n22 = new NodeSequence(4);
          n24 = jj_consume_token(LANGLE);
      n23 = JTBToolkit.makeNodeToken(n24);
      n22.addNode(n23);
          n26 = jj_consume_token(_EOF);
      n25 = JTBToolkit.makeNodeToken(n26);
      n22.addNode(n25);
          n28 = jj_consume_token(RANGLE);
      n27 = JTBToolkit.makeNodeToken(n28);
      n22.addNode(n27);
      ef = new REndOfFile();
...
// MMa : changed all character_descriptor into CharacterDescriptor to conform to class name convention
  ...
  // --- user BNFProduction java block ---
  char c1, c2 = ' ';
  // unnecessary initialization to make Java compiler happy!
 ...
 */
  ...
  Token n6 = null;
    ...
    n0.nodes.trimToSize();
    n3 = jj_consume_token(PACKAGE);
    n2 = JTBToolkit.makeNodeToken(n3);
    n4 = Name(null);
    n6 = jj_consume_token(SEMICOLON);
    n5 = JTBToolkit.makeNodeToken(n6);
    {if (true) return new PackageDeclaration(n0, n2, n4, n5);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  ...
  Token n24 = null;
    ...
    case MINUSASSIGN:
      ...
      break;
    case 136:
      n14 = jj_consume_token(136);
      n13 = JTBToolkit.makeNodeToken(n14);
      n0 = new NodeChoice(n13, 6, 12);
      break;
    case 137:
      n16 = jj_consume_token(137);
      n15 = JTBToolkit.makeNodeToken(n16);
      n0 = new NodeChoice(n15, 7, 12);
      break;
    case 138:
      n18 = jj_consume_token(138);
      n17 = JTBToolkit.makeNodeToken(n18);
      n0 = new NodeChoice(n17, 8, 12);
      break;
    case ANDASSIGN:
 ...
 */
  ...
  Token n5 = null;
    ...
    n1 = jj_consume_token(RANGLE);
    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(RANGLE);
    n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(RANGLE);
    n4 = JTBToolkit.makeNodeToken(n5);
