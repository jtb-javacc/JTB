/* Generated By:JavaCC: Do not edit this line. Token.java Version 4.2.s.m */
/* JavaCCOptions:TOKEN_EXTENDS=,KEEP_LINE_COL=null,SUPPORT_CLASS_VISIBILITY_PUBLIC=true */
package EDU.purdue.jtb.parser;

/**
 * Describes the input token stream.<br>
 * JTB requires an enhanced Token class (method newToken(int, String) and subclass GTToken.<br>
 * The ant generation task will copy it from the utils/Token.java.save, but it can also be manually
 * copied.<br>
...
public class Token implements java.io.Serializable {
  ...
  public static final Token newToken(final int ofKind, final String image) {
    switch (ofKind) {
      ...
      case JTBParserConstants.RUNSIGNEDSHIFT:
      case JTBParserConstants.RSIGNEDSHIFT:
      case JTBParserConstants.GT:
  ...
  public static class GTToken extends Token {
    ...
    int realKind = JTBParserConstants.GT;
  }
}
