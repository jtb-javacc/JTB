...
public class JTBParser extends JavaCCParserInternals implements JTBParserConstants {
  ...
  /**
   * Make a new NodeToken.
   *
   * @param tok - the (JavaCC) token
   * @return the (JTB) Nodetoken
   */
...
// ModMMa : changed all javacode_production into JavaCodeProduction to conform to class name convention
  ...
  p.setColumn(t.beginColumn);
    ...
    addproduction(p);
    {if (true) return new JavaCodeProduction(n0, n2, n3, n4, n5, n6, n16, n19);}
    throw new Error("Missing return statement in function");
  }
  ...
  p.setColumn(t.beginColumn);
    ...
    case LT:
      ...
      if (jj_2_1(2)) {
        ...
        n10 = makeNodeToken(n11);
        n9.addNode(n10);
        states = new ArrayList<String>();
          n13 = jj_consume_token(IDENTIFIER);
        n12 = makeNodeToken(n13);
        t = n13;
        n9.addNode(n12);
        states.add(t.image);
          label_6:
    ...
    case LBRACKET:
      ...
      n25 = makeNodeToken(n26);
      n24.addNode(n25);
      n28 = jj_consume_token(_IGNORE_CASE);
      n27 = makeNodeToken(n28);
      t = n28;
      n24.addNode(n27);
      n30 = jj_consume_token(RBRACKET);
      n29 = makeNodeToken(n30);
      n24.addNode(n29);
      p.ignoreCase = true;
    ...
    n31 = makeNodeToken(n32);
    n34 = jj_consume_token(LBRACE);
    n33 = makeNodeToken(n34);
    n35 = RegExprSpec(p);
    label_7:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      ...
      n17.addNode(n18);
        if (jj_2_3(2147483647)) {
          ...
          add_inline_regexpr((RegularExpression_)(c.member));
            ...
            n34 = makeNodeToken(n35);
            n33.addNode(n34);
              n37 = jj_consume_token(IDENTIFIER);
            n36 = makeNodeToken(n37);
            t = n37;
            n33.addNode(n36);
 ...
 */
  ...
  final public EmptyTypeArguments EmptyTypeArguments() throws ParseException {
  // --- JTB generated node declarations ---
  NodeToken n0 = null;
  Token n1 = null;
  NodeToken n2 = null;
  Token n3 = null;
    ...
    n2 = makeNodeToken(n3);
    {if (true) return new EmptyTypeArguments(n0, n2);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  ...
  NodeOptional n10 = new NodeOptional();
  NodeChoice n11 = null;
  EmptyTypeArguments n12 = null;
  TypeArguments n13 = null;
  NodeChoice n14 = null;
  ArrayDimsAndInits n15 = null;
  NodeSequence n16 = null;
  Arguments n17 = null;
  NodeOptional n18 = new NodeOptional();
  ClassOrInterfaceBody n19 = null;
    if (jj_2_36(2)) {
      ...
      n6.addNode(n10);
        ...
        case LPAREN:
          ...
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case LBRACE:
            n19 = ClassOrInterfaceBody(false, null);
            n18.addNode(n19);
            break;
          default:
            jj_la1[145] = jj_gen;
...
// added MMa 06/2012
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x2002,0x4,0x4,0x90800,0x2002,0x0,0x200,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10000,0x0,0x0,0x0,0x80000,0x0,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x80000,0x0,0x0,0x80000,0x10000,0x0,0x0,0x0,0x80000,0x0,0x0,0x80000,0x0,0x0,0x0,0x0,0x444c,0x4,0x0,0x444c,0x0,0x444c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x444c,0x0,0x644e,0x0,0x0,0x0,0x0,0x0,0x0,0x644e,0x0,0x2002,0x644e,0x0,0x0,0x0,0xf2892,0xf2892,0x0,0x0,0x200,0x0,0x0,0x0,0x444e,0x0,0x0,0x200,0xfb9f3,0x0,0x0,0x90,0xf2892,0x4,0x2,0x2,0x0,0x10,0x2,0x10,0x2,0x2002,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf2892,0x0,0x0,0xf2892,0xf0890,0x0,0x0,0x0,0x0,0xf0890,0x0,0x0,0xf0800,0x800,0xf2892,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfb9f3,0x0,0xfb9f3,0xfb9f3,0x0,0x0,0x0,0x0,0xf2892,0x0,0xfb9f3,0x0,0x0,0xf2892,0xf2892,0xf2892,0xf2892,0xf2892,0x0,0x0,0x0,0xf2892,0x0,0x0,0x0,0x0,0x0,0xf2892,0x0,0x444e,0x0,0x2,0x444e,};
   }
