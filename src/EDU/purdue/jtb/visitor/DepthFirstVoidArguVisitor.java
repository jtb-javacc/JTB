...
public class DepthFirstVoidArguVisitor<A> implements IVoidArguVisitor<A> {
    ...
    if (n0.present()) {
      ...
      if (n0S0A2T.present()) {
        for (int i = 0; i < n0S0A2T.size(); i++) {
          ...
          n0S0A2TMi.accept(this, argu);
        }
      }
      // #3 "}"
      final INode n0S0A3 = n0S0.elementAt(3);
      n0S0A3.accept(this, argu);
    }
  }
    ...
    if (n5.present()) {
      ...
      if (n5S0A2T.present()) {
        for (int i = 0; i < n5S0A2T.size(); i++) {
          ...
          n5S0A2TMiS1A0.accept(this, argu);
          // $1 Name()
          final INode n5S0A2TMiS1A1 = n5S0A2TMiS1.elementAt(1);
          n5S0A2TMiS1A1.accept(this, argu);
        }
      }
    }
    // f6 -> Block()
  ...
  public void visit(final BNFProduction n, final A argu) {
    ...
    if (n4.present()) {
      ...
      n4S0A0.accept(this, argu);
      // #1 Name()
      final INode n4S0A1 = n4S0.elementAt(1);
      n4S0A1.accept(this, argu);
      // #2 ( $0 "," $1 Name() )*
      ...
      if (n4S0A2T.present()) {
        for (int i = 0; i < n4S0A2T.size(); i++) {
          ...
          n4S0A2TMiS1A0.accept(this, argu);
          // $1 Name()
          final INode n4S0A2TMiS1A1 = n4S0A2TMiS1.elementAt(1);
          n4S0A2TMiS1A1.accept(this, argu);
        }
      }
    }
    // f5 -> [ "!" ]
  ...
  public void visit(final RegularExprProduction n, final A argu) {
    ...
    if (n6.present()) {
      for (int i = 0; i < n6.size(); i++) {
        ...
        n6MiS0A0.accept(this, argu);
        // #1 RegExprSpec()
        final INode n6MiS0A1 = n6MiS0.elementAt(1);
        n6MiS0A1.accept(this, argu);
      }
    }
    // f7 -> "}"
    final NodeToken n7 = n.f7;
  ...
  public void visit(final RegExprSpec n, final A argu) {
    ...
    if (n3.present()) {
      ...
      n3S0A0.accept(this, argu);
      // #1 <IDENTIFIER>
      final INode n3S0A1 = n3S0.elementAt(1);
      n3S0A1.accept(this, argu);
    }
  }
      ...
      case 4:
        ...
        switch (n0CHS2A1C.which) {
          case 0:
            ...
            n0CHS2A1CHS30A0.accept(this, argu);
            // $1 Arguments()
            final INode n0CHS2A1CHS30A1 = n0CHS2A1CHS3.elementAt(1);
            n0CHS2A1CHS30A1.accept(this, argu);
            // $2 [ "!" ]
            ...
            if (n0CHS2A1CHS30A2P.present()) {
              n0CHS2A1CHS30A2P.accept(this, argu);
            }
            break;
          case 1:
            // &1 $0 RegularExpression()
            ...
            n0CHS2A1CHS41A0.accept(this, argu);
            // $1 [ ?0 "." ?1 <IDENTIFIER> ]
            ...
            if (n0CHS2A1CHS41A1P.present()) {
              ...
              n0CHS2A1CHS41A1PS5A0.accept(this, argu);
              // ?1 <IDENTIFIER>
              final INode n0CHS2A1CHS41A1PS5A1 = n0CHS2A1CHS41A1PS5.elementAt(1);
              n0CHS2A1CHS41A1PS5A1.accept(this, argu);
            }
            // $2 [ "!" ]
            ...
            if (n0CHS2A1CHS4A2P.present()) {
              n0CHS2A1CHS4A2P.accept(this, argu);
            }
            break;
          default:
            // should not occur !!!
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        if (n0CHS11A0P.present()) {
          ...
          n0CHS11A0PS2A0.accept(this, argu);
          // $1 "."
          final INode n0CHS11A0PS2A1 = n0CHS11A0PS2.elementAt(1);
          n0CHS11A0PS2A1.accept(this, argu);
        }
        // #1 "super"
    ...
    switch (n0C.which) {
      case 0:
        ...
        for (int i = 0; i < n0CHS00A1L.size(); i++) {
          ...
          n0CHS00A1LEiS1A0.accept(this, argu);
          // $1 "]"
          final INode n0CHS00A1LEiS1A1 = n0CHS00A1LEiS1.elementAt(1);
          n0CHS00A1LEiS1A1.accept(this, argu);
        }
        break;
      case 1:
        // %1 #0 ClassOrInterfaceType()
        ...
        if (n0CHS11A1T.present()) {
          for (int i = 0; i < n0CHS11A1T.size(); i++) {
            ...
            n0CHS11A1TMiS2A0.accept(this, argu);
            // $1 "]"
            final INode n0CHS11A1TMiS2A1 = n0CHS11A1TMiS2.elementAt(1);
            n0CHS11A1TMiS2A1.accept(this, argu);
          }
        }
        break;
      default:
      ...
      case 0:
        ...
        if (n0CHS0A1T.present()) {
          for (int i = 0; i < n0CHS0A1T.size(); i++) {
            ...
            n0CHS0A1TMiS1A0.accept(this, argu);
            // $1 "]"
            final INode n0CHS0A1TMiS1A1 = n0CHS0A1TMiS1.elementAt(1);
            n0CHS0A1TMiS1A1.accept(this, argu);
          }
        }
        break;
      case 1:
        ...
        for (int i = 0; i < n0CHS11A0L1.size(); i++) {
          ...
          n0CHS11A0L1EiS2A0.accept(this, argu);
          // $1 "]"
          final INode n0CHS11A0L1EiS2A1 = n0CHS11A0L1EiS2.elementAt(1);
          n0CHS11A0L1EiS2A1.accept(this, argu);
        }
        // #1 ArrayInitializer()
        final INode n0CHS1A1 = n0CHS1.elementAt(1);
        n0CHS1A1.accept(this, argu);
  ...
  public void visit(final Statement n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 4:
        ...
        n0CHS04A0.accept(this, argu);
        // #1 ";"
        final INode n0CHS04A1 = n0CHS0.elementAt(1);
        n0CHS04A1.accept(this, argu);
        break;
      case 5:
        // %05 SwitchStatement()
        n0CH.accept(this, argu);
        ...
        if (n0CHS02A1P.present()) {
          ...
          switch (n0CHS02A1PC.which) {
            ...
            case 2:
              ...
              n0CHS02A1PCHS12A0.accept(this, argu);
              // $1 Expression()
              final INode n0CHS02A1PCHS12A1 = n0CHS02A1PCHS1.elementAt(1);
              n0CHS02A1PCHS12A1.accept(this, argu);
              break;
            default:
              // should not occur !!!
              break;
        ...
        switch (n0CHS00A1C.which) {
          case 0:
            ...
            if (n0CHS00A1CHS10A4P.present()) {
              n0CHS00A1CHS10A4P.accept(this, argu);
            }
            // $5 ";"
            final INode n0CHS00A1CHS1A5 = n0CHS00A1CHS1.elementAt(5);
            n0CHS00A1CHS1A5.accept(this, argu);
            break;
          case 1:
            // &1 ClassOrInterfaceDeclaration()
            n0CHS00A1CH.accept(this, argu);
            break;
          case 2:
            // &2 EnumDeclaration()
            n0CHS00A1CH.accept(this, argu);
