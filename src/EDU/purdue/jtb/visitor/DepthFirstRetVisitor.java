      ...
      case 4:
        ...
        switch (n0CHS2A1C.which) {
          case 0:
            ...
            nRes = n0CHS2A1CHS30A0.accept(this);
            // $1 Arguments()
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        if (n0CHS11A0P.present()) {
          ...
          nRes = n0CHS11A0PS2A0.accept(this);
          // $1 "."
          final INode n0CHS11A0PS2A1 = n0CHS11A0PS2.elementAt(1);
          nRes = n0CHS11A0PS2A1.accept(this);
        }
        // #1 "super"
    ...
    switch (n0C.which) {
      case 0:
        ...
        for (int i = 0; i < n0CHS00A1L.size(); i++) {
          ...
          nRes = n0CHS00A1LEiS1A0.accept(this);
          // $1 "]"
          final INode n0CHS00A1LEiS1A1 = n0CHS00A1LEiS1.elementAt(1);
          nRes = n0CHS00A1LEiS1A1.accept(this);
        }
        break;
      case 1:
        // %1 #0 ClassOrInterfaceType()
        ...
        if (n0CHS11A1T.present()) {
          for (int i = 0; i < n0CHS11A1T.size(); i++) {
            ...
            nRes = n0CHS11A1TMiS2A0.accept(this);
            // $1 "]"
            final INode n0CHS11A1TMiS2A1 = n0CHS11A1TMiS2.elementAt(1);
            nRes = n0CHS11A1TMiS2A1.accept(this);
          }
        }
        break;
      default:
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        for (int i = 0; i < n0CHS11A0L1.size(); i++) {
          ...
          nRes = n0CHS11A0L1EiS2A0.accept(this);
          // $1 "]"
          final INode n0CHS11A0L1EiS2A1 = n0CHS11A0L1EiS2.elementAt(1);
          nRes = n0CHS11A0L1EiS2A1.accept(this);
        }
        // #1 ArrayInitializer()
        final INode n0CHS1A1 = n0CHS1.elementAt(1);
        nRes = n0CHS1A1.accept(this);
  ...
  public R visit(final Statement n) {
    ...
    switch (n0C.which) {
      ...
      case 4:
        ...
        nRes = n0CHS04A0.accept(this);
        // #1 ";"
        final INode n0CHS04A1 = n0CHS0.elementAt(1);
        nRes = n0CHS04A1.accept(this);
        break;
      case 5:
        // %05 SwitchStatement()
        nRes = n0CH.accept(this);
        ...
        if (n0CHS02A1P.present()) {
          ...
          switch (n0CHS02A1PC.which) {
            ...
            case 2:
              ...
              nRes = n0CHS02A1PCHS12A0.accept(this);
              // $1 Expression()
              final INode n0CHS02A1PCHS12A1 = n0CHS02A1PCHS1.elementAt(1);
              nRes = n0CHS02A1PCHS12A1.accept(this);
              break;
            default:
              // should not occur !!!
              break;
  ...
  public R visit(final ForStatement n) {
    ...
    switch (n2C.which) {
      case 0:
        ...
        nRes = n2CHS00A3.accept(this);
        // #4 Expression()
        final INode n2CHS00A4 = n2CHS0.elementAt(4);
        nRes = n2CHS00A4.accept(this);
        break;
      case 1:
        // %1 #0 [ ForInit() ]
        // .. #1 ";"
      ...
      case 0:
        ...
        switch (n0CHS00A1C.which) {
          case 0:
            ...
            nRes = n0CHS00A1CHS10A2.accept(this);
            // $3 ")"
            final INode n0CHS00A1CHS10A3 = n0CHS00A1CHS1.elementAt(3);
            nRes = n0CHS00A1CHS10A3.accept(this);
            // $4 [ DefaultValue() ]
            ...
            if (n0CHS00A1CHS10A4P.present()) {
              nRes = n0CHS00A1CHS10A4P.accept(this);
            }
            // $5 ";"
            final INode n0CHS00A1CHS1A5 = n0CHS00A1CHS1.elementAt(5);
            nRes = n0CHS00A1CHS1A5.accept(this);
            break;
          case 1:
            // &1 ClassOrInterfaceDeclaration()
            nRes = n0CHS00A1CH.accept(this);
            break;
          case 2:
            // &2 EnumDeclaration()
            nRes = n0CHS00A1CH.accept(this);
