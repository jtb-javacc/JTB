    ...
    if (n5.present()) {
      ...
      if (n5S0A2T.present()) {
        for (int i = 0; i < n5S0A2T.size(); i++) {
          ...
          n5S0A2TMiS1A0.accept(this);
          // $1 Name()
          final INode n5S0A2TMiS1A1 = n5S0A2TMiS1.elementAt(1);
          n5S0A2TMiS1A1.accept(this);
        }
      }
    }
    // f6 -> Block()
    ...
    if (n4.present()) {
      ...
      if (n4S0A2T.present()) {
        for (int i = 0; i < n4S0A2T.size(); i++) {
          ...
          n4S0A2TMiS1A0.accept(this);
          // $1 Name()
          final INode n4S0A2TMiS1A1 = n4S0A2TMiS1.elementAt(1);
          n4S0A2TMiS1A1.accept(this);
        }
      }
    }
    // f5 -> [ "!" ]
  ...
  public void visit(final RegularExprProduction n) {
    ...
    if (n6.present()) {
      for (int i = 0; i < n6.size(); i++) {
        ...
        n6MiS0A0.accept(this);
        // #1 RegExprSpec()
        final INode n6MiS0A1 = n6MiS0.elementAt(1);
        n6MiS0A1.accept(this);
      }
    }
    // f7 -> "}"
    final NodeToken n7 = n.f7;
