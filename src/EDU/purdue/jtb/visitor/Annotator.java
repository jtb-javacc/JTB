...
public abstract class Annotator extends JavaCCPrinter {
  ...
  protected abstract String newConstructor();

  protected abstract  String qualifier();

  protected abstract  String makeNodeToken();

  protected abstract  String niew();
