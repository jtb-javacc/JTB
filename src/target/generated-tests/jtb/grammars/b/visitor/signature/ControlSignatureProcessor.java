...
package grammars.b.visitor.signature;
...
import grammars.b.syntaxtree.NodeConstants;
 ...
 */
@SupportedAnnotationTypes("grammars.b.visitor.signature.NodeFieldsSignature")
      ...
      for (final Element elem : roundEnv.getElementsAnnotatedWith(NodeFieldsSignature.class)) {
        ...
        if (osig != nsig) {
          final String message = "Different node fields signatures (old=" + nfs.value()[0] + ", new=" +
                                 nfs.value()[1] + ") in grammars.b.visitor." +
