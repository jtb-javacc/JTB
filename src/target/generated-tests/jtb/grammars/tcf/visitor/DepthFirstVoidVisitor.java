...
public class DepthFirstVoidVisitor implements IVoidVisitor {
  ...
  public void visit(final Start n) {
    ...
    switch (nch.which) {
      ...
      case 1:
        ...
        //&1 bp_iv3_()
        final INode nd6 = seq1.elementAt(6);
        nd6.accept(this);
        break;
      default:
        // should not occur !!!
   ...
   */
  @Override
  @NodeFieldsSignature({ -1969773913, JTB_SIG_TCF1, JTB_USER_TCF1 })
   ...
   */
  @Override
  @NodeFieldsSignature({ 1526084756, JTB_SIG_TCF2, JTB_USER_TCF2 })
   ...
   */
  @Override
  @NodeFieldsSignature({ 1429321349, JTB_SIG_TCF3, JTB_USER_TCF3 })
   ...
   */
  @Override
  @NodeFieldsSignature({ 887598099, JTB_SIG_TCF4, JTB_USER_TCF4 })
   ...
   */
  @Override
  @NodeFieldsSignature({ -1048223857, JTB_SIG_INTEGER_LITERAL, JTB_USER_INTEGER_LITERAL })
