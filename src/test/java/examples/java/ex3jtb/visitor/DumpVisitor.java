...
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_NODE_NAME;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_ASTSTART;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_SIG_ASTADDITIVEEXPRESSION;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_SIG_ASTINTEGER;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_SIG_ASTMULTIPLICATIVEEXPRESSION;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_SIG_ASTMYID;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_SIG_ASTSTART;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_SIG_ASTUNARYEXPRESSION;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_ASTADDITIVEEXPRESSION;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_ASTINTEGER;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_ASTMULTIPLICATIVEEXPRESSION;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_ASTMYID;
import static examples.java.ex3jtb.syntaxtree.NodeConstants.JTB_USER_ASTUNARYEXPRESSION;
