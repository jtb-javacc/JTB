...
package grammars.z.visitor.signature;
...
import grammars.z.syntaxtree.NodeConstants;
 ...
 */
@SupportedAnnotationTypes("grammars.z.visitor.signature.NodeFieldsSignature")
      ...
      for (final Element elem : roundEnv.getElementsAnnotatedWith(NodeFieldsSignature.class)) {
        ...
        if (osig != nsig) {
          final String message = "Different node fields signatures (old=" + nfs.value()[0] + ", new=" +
                                 nfs.value()[1] + ") in grammars.z.visitor." +
